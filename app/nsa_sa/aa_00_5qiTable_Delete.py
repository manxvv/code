    ...
    def create_rpc_msg(self):
        ...
        self.mo_dict['5qi'] = {
            ...
            'GNBDUFunction': {'gNBDUFunctionId': '1', 'DU5qiTable': {
                'attributes': {'xc:operation': 'delete'}, 'dU5qiTableId': '1', 'default5qiTable': 'true', 'DU5qi': []}},
            'GNBCUCPFunction': {'gNBCUCPFunctionId': '1', 'CUCP5qiTable': {
                'attributes': {'xc:operation': 'delete'}, 'cUCP5qiTableId': '1', 'default5qiTable': 'true', 'CUCP5qi': []}},
            'GNBCUUPFunction': {'gNBCUUPFunctionId': '1', 'CUUP5qiTable': {
                'attributes': {'xc:operation': 'delete'}, 'cUUP5qiTableId': '1', 'default5qiTable': 'true', 'CUUP5qi': []}},
        }
